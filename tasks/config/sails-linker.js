  ...
  grunt.config.set('sails-linker', {
    ...
    prodJs: {
      options: {
        startTag: '<!--SCRIPTS-->',
        endTag: '<!--SCRIPTS END-->',
        fileTmpl: '<script src="<%=cndUrl%>%s?v=<%=timeStamp%>"></script>',
        appRoot: '.tmp/public'
      },
      files: {
    ...
    devMobileJs: {
      options: {
        startTag: '<!--MOBILE-SCRIPTS-->',
        endTag: '<!--MOBILE-SCRIPTS END-->',
        fileTmpl: '<script src="%s"></script>',
        appRoot: '.tmp/public'
      },
      files: {
        '.tmp/public/**/*.html': require('../pipeline').mobileJsFilesToInject,
        'views/**/*.html': require('../pipeline').mobileJsFilesToInject,
        'views/**/*.ejs': require('../pipeline').mobileJsFilesToInject
      }
    },
    ...
    prodStyles: {
      options: {
        startTag: '<!--STYLES-->',
        endTag: '<!--STYLES END-->',
        fileTmpl: '<link rel="stylesheet" href="<%=cndUrl%>%s?v=<%=timeStamp%>">',
        appRoot: '.tmp/public'
      },
      files: {
    ...
    devMobileStyles: {
      options: {
        startTag: '<!--MOBILE-STYLES-->',
        endTag: '<!--MOBILE-STYLES END-->',
        fileTmpl: '<link rel="stylesheet" href="%s">',
        appRoot: '.tmp/public'
      },

      files: {
        '.tmp/public/**/*.html': require('../pipeline').mobileCssFilesToInject,
        'views/**/*.html': require('../pipeline').mobileCssFilesToInject,
        'views/**/*.ejs': require('../pipeline').mobileCssFilesToInject
      }
    },

    devMobileStylesRelative: {
      options: {
        startTag: '<!--MOBILE-STYLES-->',
        endTag: '<!--MOBILE-STYLES END-->',
        fileTmpl: '<link rel="stylesheet" href="%s">',
    ...
    prodMobileStyles: {
      ...
      files: {
        '.tmp/public/index.html': ['.tmp/public/min/production.mobile.min.css'],
        'views/**/*.html': ['.tmp/public/min/production.mobile.min.css'],
        'views/**/*.ejs': ['.tmp/public/min/production.mobile.min.css']
      }
    },

    prodMobileStylesRelative: {
      options: {
        startTag: '<!--MOBILE-STYLES-->',
        endTag: '<!--MOBILE-STYLES END-->',
        fileTmpl: '<link rel="stylesheet" href="<%=cndUrl%>%s?v=<%=timeStamp%>">',
