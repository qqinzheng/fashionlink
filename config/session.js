...
module.exports.session = {
  ...
  *                                                                          *
  ***************************************************************************/
  secret: 'a318a44e9290ac476d09057fbbebbe82',
  ...
  ***************************************************************************/
  ...
  adapter: 'mongo',
  url: 'mongodb://localhost:27017/fashionlink', // user, password and port optional
...
if(process.env!=='production'){
  ...
  module.exports.session.url=null ;
  module.exports.session.collection=null ;
  module.exports.session.mongoOptions = null;
}
