...
module.exports.views = {
  ...
  ****************************************************************************/
  ...
  locals: {
      isProduction:process.env.RUN_ENV=='production',
      language:i18n.defaultLocale,
      cndUrl:process.env.RUN_ENV=='production'?webConfig.cdnUrl:"",
      videoCdnUrl:process.env.RUN_ENV=='production'?webConfig.videoCdnUrl:"",
  }
